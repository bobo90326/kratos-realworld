...
type RealWorldClient interface {
	...
	ListArticles(ctx context.Context, in *ListArticlesRequest, opts ...grpc.CallOption) (*ProfileReply, error)
	FeedArticles(ctx context.Context, in *FeedArticlesRequest, opts ...grpc.CallOption) (*MultipleArticlesRely, error)
...
func (c *realWorldClient) ListArticles(ctx context.Context, in *ListArticlesRequest, opts ...grpc.CallOption) (*ProfileReply, error) {
	out := new(ProfileReply)
...
func (c *realWorldClient) FeedArticles(ctx context.Context, in *FeedArticlesRequest, opts ...grpc.CallOption) (*MultipleArticlesRely, error) {
	out := new(MultipleArticlesRely)
...
func (c *realWorldClient) AddComments(ctx context.Context, in *AddCommentsRequest, opts ...grpc.CallOption) (*SingleCommentReply, error) {
	...
	err := c.cc.Invoke(ctx, RealWorld_AddComments_FullMethodName, in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
type RealWorldServer interface {
	...
	FeedArticles(context.Context, *FeedArticlesRequest) (*MultipleArticlesRely, error)
...
func (UnimplementedRealWorldServer) ListArticles(context.Context, *ListArticlesRequest) (*ProfileReply, error) {
	return nil, status.Errorf(codes.Unimplemented, "method ListArticles not implemented")
}
func (UnimplementedRealWorldServer) FeedArticles(context.Context, *FeedArticlesRequest) (*MultipleArticlesRely, error) {
